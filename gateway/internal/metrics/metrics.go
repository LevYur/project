...
var (
	HttpRequestsTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			...
			ConstLabels: prometheus.Labels{"service": "project/gateway"},
		},
	...
	GatewayInvalidLoginRequestTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name:        "project/gateway_invalid_login_request_total",
	...
	GatewayInvalidRegisterRequestTotal = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name:        "project/gateway_invalid_register_request_total",
